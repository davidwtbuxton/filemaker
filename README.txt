To use this module create a sub-class of the FMPImporter class and override the
...
strings, but you can customize the conversion by overriding the appropriate
